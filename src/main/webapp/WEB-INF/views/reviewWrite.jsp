		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="/Reservation/my-reservation" class="btn_back" title="이전 화면으로 이동">
				...
				<div class="review_contents write">
					...
					<a class="review_write_info"> <span class="middot"> 실
							사용자의 리뷰는 상품명의 더 나은 서비스 제공과 다른 사용자들의 선택에 큰 도움이 됩니다. </span><br> <span
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="hidden" class="hidden_input" id="productId" value="${reservation.productId}">
						<input type="hidden" class="hidden_input" id="reservationInfoId" value="${reservation.id}"> 
						<input type="file" class="hidden_input" id="reviewImageFileOpenInput" accept="image/*" multiple>
						<div class="guide_review">
							<span id="text_count">0</span>/400 <span>(최소5자이상)</span>
						</div>
					</div>
