        ...
        <div class="header">
            <header class="header_tit">
                <h1 class="logo">
                    ...
                    <a href="htmls/myreservation.html" class="lnk_logo" title="예약"> 
                    	<span class="spr_bi ico_bk_logo">예약</span> 
                    </a>
                </h1>
                <a href="htmls/bookinglogin.html" class="btn_my"> 
            ...
            <div class="section_event_lst">
                ...
                <div class="wrap_event_box">
                    ...
                    <ul class="lst_event_box">
                        <li class="item">
                            <a href="htmls/detail.html" class="item_book">
                                ...
                                <div class="event_txt">
                                    <h4 class="event_txt_tit"> 
                                    	<span>뮤지컬 드림걸즈(DREAMGIRLS) 최초 내한</span> 
                        ...
                        <li class="item">
                            <a href="htmls/detail.html" class="item_book">
                                <div class="item_preview"> 
                                	<img alt="뮤지컬 더 데빌 The DEVIL" class="img_thumb" src="https://ssl.phinf.net/naverbooking/20170111_195/1484112206459rGQGI_JPEG/%BB%F3%BC%BC%C6%E4%C0%CC%C1%F6_%BB%F3%B4%DC%28%B3%D7%C0%CC%B9%F6_%BF%B9%BE%E0%29.jpg?type=l591_945">                                    
                                	<span class="img_border"></span> 
                                </div>
                                <div class="event_txt">
                                    <h4 class="event_txt_tit"> 
                                    	<span>뮤지컬 더 데빌 The DEVIL</span> 
                    ...
                    <ul class="lst_event_box">
                        <li class="item">
                            <a href="htmls/detail.html" class="item_book">
                                <div class="item_preview"> 
                                	<img alt="뮤지컬 로미오와 줄리엣" class="img_thumb" src="https://ssl.phinf.net/naverbooking/20170119_135/1484789767866RPO6o_JPEG/%B7%CE%B9%CC%BF%C0%C1%D9%B8%AE%BF%A7_1242.jpg?type=l591_945"> 
                                	<span class="img_border"></span> 
                                </div>
                                <div class="event_txt">
                                    <h4 class="event_txt_tit"> 
                        ...
                        <li class="item">
                            <a href="htmls/detail.html" class="item_book">
                                <div class="item_preview"> 
                                	<img alt="뮤지컬 인 더 하이츠(IN THE HEIGHTS)" class="img_thumb" src="https://ssl.phinf.net/naverbooking/20170111_225/1484116579024rNkXW_JPEG/2016_%B9%C2%C1%F6%C4%C3_%C0%CE_%B4%F5_%C7%CF%C0%CC%C3%F7_%C6%F7%BD%BA%C5%CD%2820MB%29.jpg?type=l591_945">                                    
                                	<span class="img_border"></span> 
                                </div>
                                <div class="event_txt">
                                    <h4 class="event_txt_tit"> 
                                    	<span>뮤지컬 인 더 하이츠(IN THE HEIGHTS)</span> 
